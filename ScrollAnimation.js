...
lib.ssMetadata = [
		{name:"Foglie_20Scroll_atlas_1", frames: [[0,1059,290,687],[0,0,319,1057]]}
];
...
(lib.Fogliadx = function() {
	this.initialize(ss["Foglie_20Scroll_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.Senzanome4 = function(mode,startPosition,loop,reversed) {
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/Foglie_20Scroll_atlas_1.png", id:"Foglie_20Scroll_atlas_1"}
	],
	preloads: []
};
